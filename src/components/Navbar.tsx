...
function MagneticLink({
  ...
  return (
    <motion.button
      ref={ref}
      style={{ x: springX, y: springY, position: 'relative', background: 'none', border: 'none', cursor: 'pointer', padding: compact ? '4px 2px' : '6px 2px' }}
        ...
        >
          <div className="container-xl flex items-center justify-between" style={{ height: 72 }}>
            ...
            >
              ...
              <span style={{ fontFamily: 'Space Grotesk, sans-serif', fontWeight: 700, fontSize: 18, letterSpacing: '-0.03em', color: '#fff' }}>
                Digital Shine
              </span>
            </motion.button>
            ...
            <div
              ...
              style={{
                gap: 4, padding: '6px 8px', borderRadius: 100,
            ...
            >
              {navLinks.map((link, i) => (
                ...
                >
                  <MagneticLink label={link.label} href={link.href} onClick={handleNav} active={activeSection === link.href.replace('#', '')} />
                </motion.div>
              ))}
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <motion.span
                  variants={{ hover: { x: ['−100%', '200%'], opacity: [0, 0.6, 0] } }}
                ...
                />
                Start Project
                <motion.svg variants={{ hover: { x: 3 } }} transition={{ type: 'spring', stiffness: 400, damping: 20 }}
              ...
              <button
                ...
                style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)', cursor: 'pointer', gap: 5 }}
              >
          ...
          >
            <div
              style={{
                ...
                boxShadow: '0 8px 40px rgba(0,0,0,0.5), 0 0 0 1px rgba(79,140,255,0.08), inset 0 1px 0 rgba(255,255,255,0.06)',
              }}
            >
              {/* Logo mark only */}
              <motion.button
                ...
                style={{
                  ...
                  boxShadow: '0 0 16px rgba(79,140,255,0.4)',
                }}
              >
                <svg width="15" height="15" viewBox="0 0 18 18" fill="none">
                  <path d="M9 1.5L16.5 5.5V12.5L9 16.5L1.5 12.5V5.5L9 1.5Z" stroke="white" strokeWidth="1.4" fill="none" />
                  <path d="M9 1.5V16.5M1.5 5.5L16.5 12.5M16.5 5.5L1.5 12.5" stroke="white" strokeWidth="0.7" opacity="0.5" />
                </svg>
              </motion.button>

              {/* Divider */}
              <div style={{ width: 1, height: 20, background: 'rgba(255,255,255,0.1)', marginRight: 6 }} />

              {/* Nav links */}
              {navLinks.map(link => (
                <div key={link.label} style={{ padding: '0 8px' }}>
                  <MagneticLink
                    label={link.label}
                    href={link.href}
                    onClick={handleNav}
              ...
              <motion.button
                ...
                style={{
                  ...
                  background: 'linear-gradient(135deg, #4f8cff 0%, #7b5cff 100%)',
                  border: 'none', borderRadius: 100,
                  padding: '8px 18px', cursor: 'pointer', marginLeft: 4,
                  fontFamily: 'Space Grotesk, sans-serif', fontSize: 13, fontWeight: 600,
                  color: '#fff', letterSpacing: '-0.01em', display: 'flex', alignItems: 'center', gap: 6,
                  boxShadow: '0 2px 16px rgba(79,140,255,0.4)',
                  flexShrink: 0,
                }}
              >
                <motion.span
        ...
        {mobileOpen && (
          <motion.div
            ...
            style={{
              ...
              zIndex: 998,
              display: 'flex', flexDirection: 'column', padding: '32px 28px 40px',
            }}
          >
            <div style={{ position: 'absolute', top: '20%', left: '50%', transform: 'translate(-50%,0)', width: 400, height: 300, background: 'radial-gradient(ellipse at center, rgba(79,140,255,0.08) 0%, transparent 70%)', pointerEvents: 'none' }} />
              ...
              {navLinks.map((link, i) => (
                <motion.button
                  ...
                  style={{
                    ...
                    padding: '10px 0', letterSpacing: '-0.04em', transition: 'color 0.3s',
